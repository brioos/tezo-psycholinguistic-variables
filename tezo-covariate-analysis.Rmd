...
radar_cov <- rbind(max_min, norm_cov)
radar_cov

radarchart(radar_cov, axistype = 1, pcol = colors[cov], plwd=2 ,plty=1, 
           title = "Cluster characteristics: Feature means per cluster", cglcol = "grey", 
           cglty = 1, axislabcol = "grey", caxislabels = seq(0, 1, .2), cglwd = 0.8)
```
